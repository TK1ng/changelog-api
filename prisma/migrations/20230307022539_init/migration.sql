...
CREATE TABLE "UpdateFeatures" (
    ...
    CONSTRAINT "UpdateFeatures_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "UpdateFeatures" ADD CONSTRAINT "UpdateFeatures_updateId_fkey" FOREIGN KEY ("updateId") REFERENCES "Update"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
